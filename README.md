...
#### gUFW:
Відкрийте "Центр керування -> Налаштування брандмауера" в графічному інтерфейсі, або наберіть в терміналі:

```bash
sudo gufw
``` 

У вікні на домашній сторінці ви можете ознайомитись з елементарними правилами роботи графічного інтерфейсу Стіни Вогню (фаєрволу). Ви можете використовувати профіль за замовчанням, або створити собі окремі профілі для дому, офісу та публічного простору. Обравши профіль увімкніть перемиуач "Стан". Перемикач "Вхідні" оберіть "Заборонити". Перемикач "Вихідні" оберіть "Дозволити". Відтепер всі спроби отримати доступ ззовні будуть ігноруватись, а ваші запити на зовнішні ресурси будуть працювати.

Якщо ви маєте сервіси, які повинні працювати за іншими правилами, ви можете такі правила створити у розділі "Правила", для цього натисніть плюсик (лівий нижній кут екрану) та налаштуйте відповідне правило у віконці налаштування що відкриється. 
